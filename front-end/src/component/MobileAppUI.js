...
const MobileAppUI = ({ chatHistory, onSendMessage, interactionState, aiResponse, onNavigate, activePath }) => {
  ...
  return (
    <div className="mobile-ui-container">
      ...
      <header className="mobile-header">
        ...
        <button className="menu-btn" onClick={() => onNavigate && onNavigate('/system')}>
          <span></span>
          <span></span>
          <span></span>
        </button>
      ...
      <main className="mobile-content">
        ...
        {/* Action Grid (only show if no chat history) */}
        {(!chatHistory || chatHistory.length === 0) && (
          <div className="action-grid">
            {/* Card 1 */}
            <div className="action-card" onClick={() => onSendMessage("Generate an image of")}>
            ...
            {/* Card 2 */}
            <div className="action-card" onClick={() => onSendMessage("Help me write or edit a text about")}>
              <div className="action-icon">
            ...
            {/* Card 3 */}
            <div className="action-card" onClick={() => onSendMessage("Look up information about")}>
              <div className="action-icon">
            ...
            {/* Card 4 */}
            <div className="action-card" onClick={() => onSendMessage("Help me code")}>
              <div className="action-icon">
      ...
      <nav className="bottom-nav">
        ...
        <div className={`nav-item ${activePath === '/system' ? 'active' : ''}`} onClick={() => onNavigate && onNavigate('/system')}>
